...
\section{Introduction}
    ...
    In ??, Oomstrom presents a property called Z, which turns out to be a sufficient condiction to get confluence. For a given abstract rewriting system (\coqdocvar{A},\symbol{92}\coqdocvar{to}), one says that it satisfies the Z property if, forall \coqdocvar{a},\coqdocvar{b} \symbol{92}\coqdoctac{in} \coqdocvar{A} there exists a function \coqdocvar{f}: \coqdocvar{A} \symbol{92}\coqdocvar{to} \coqdocvar{A} such that 
