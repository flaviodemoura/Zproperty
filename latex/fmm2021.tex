...
\coqdocemptyline
\coqdocindent{3.00em}
\ensuremath{\times} \coqdoctac{apply} \coqdocvar{H1} \coqdoctac{in} \coqdocvar{H}. \coqdoctac{destruct} \coqdocvar{H} \coqdockw{as} [\coqdocvar{Hb} \coqdocvar{Hf}]. \coqdoctac{apply} (\coqdocvar{refltrans\_union} \coqdocvar{R1} \coqdocvar{R2}) \coqdoctac{in} \coqdocvar{Hb}. \coqdoctac{apply} \coqdocvar{refltrans_union_equiv} \coqdockw{with} \coqdocvar{R1} \coqdocvar{R2}. 
\coqdocemptyline
\coqdocindent{4.00em}
...
\comm{From hypothesis $H2$, we
        ...
        $a\tto_{(R1\cup R2)} (f_1\ a)$ and we are done.} \begin{coqdoccode}
\coqdocemptyline
\coqdocindent{3.00em}
