...
implies confluence. In addition, we formally proved this result in 
the Coq proof assistant\footnote{The corresponding files are available at
 \url{https://github.com/flaviodemoura/Zproperty}.}
