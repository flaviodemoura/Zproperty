...
\fbox{\minipage[r]{10cm}For the base case, which corresponds to the rule [refl], $t$ and $u$ are the same element and hence the goal coincides with the hipothesis $H2$.\end{minipage}} \begin{coqdoccode}
\coqdocemptyline
\coqdocindent{1.00em}
