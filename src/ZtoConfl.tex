...
\comm{Unfolding both definitions of
  $Z\_prop$ and $Confl$, we get the following proof context:
     ...
     \includegraphics[scale=0.5]{fig3.png} } \begin{coqdoccode}
\coqdocemptyline
\coqdocindent{1.00em}
...
\comm{We know from the hypothesis
     ...
     $g$ this mapping, and we get following proof context:
      ...
      \symbol{92}includegraphics\coqdocvar{scale}=0.6\{fig4.png\}
...
\comm{The second subgoal corresponds
        ...
        \includegraphics[scale=0.48]{fig7.png} } \begin{coqdoccode}
\coqdocemptyline
\coqdocindent{3.00em}
...
\coqdocemptyline
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqdocvar{Z\_prop}. \coqdoctac{unfold} \coqdocvar{Z\_comp} \coqdoctac{in} \coqdocvar{H}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{destruct} \coqdocvar{H} \coqdockw{as} [ \coqdocvar{R1} [ \coqdocvar{R2} [\coqdocvar{f1} [\coqdocvar{f2}\coqdoceol
\coqdocindent{1.00em}
[\coqdocvar{Hunion} [\coqdocvar{H1} [\coqdocvar{H2} [\coqdocvar{H3} \coqdocvar{H4}]]]]]]]]. \end{coqdoccode}
\comm{Now
      ...
      \includegraphics[scale=0.5]{fig8.png} } \begin{coqdoccode}
\coqdocemptyline
\coqdocindent{1.00em}
