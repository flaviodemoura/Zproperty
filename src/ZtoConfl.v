...
Proof.
  ...
  - intros c0 Hrefl2. (** %\comm{Let $c_0$ be a reduct of $a$, and $Hrefl2$
    ...
    + intros b0 Hrefl1 IHHrefl1 Hb0ga. (** %\comm{The second subgoal corresponds
      ...
      * apply refltrans_composition with (g a); [ assumption | apply HZ_prop; assumption]. (** %\comm{4. $b0 \tto_R (g\ b)$: This is proved by the transitivity of
...
Proof.
  ...
  unfold Z_prop.  unfold Z_comp in H.  destruct H as [ R1 [ R2 [f1 [f2 [Hunion [H1 [H2 [H3 H4]]]]]]]]. (** %\comm{Now
  ...
  - split. (** %\comm{Firstly, suppose that $a$ $R1$-reduces in one step to
    ...
    get that $(f_1\ a) \tto_{R1} (f_1\ b)$ by the Z property.}% *)
      ...
      * apply refltrans_composition with (f2 b0). (** %\comm{In the
